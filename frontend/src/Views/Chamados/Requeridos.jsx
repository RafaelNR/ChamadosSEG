...
//* SERVICE
import { getChamadosRequeridosFromMe, getCountTypeAcompanhamentos } from '../../Service/chamados.service';
...
const getChamados = async () => {
  try {
    ...
    const Chamados = await getChamadosRequeridosFromMe();
  ...
  return (
    <>
      {loading ? (
        ...
        }) : (<div className={classes.text}> Sem chamados requeridos por você </div>) 
      )}
    </>
  );
};
