...
import { User, ViewDescricaoText } from '../../../Components/Box/AcmChamado';
  ...
  return (
    ...
    >
      {userDados.id === acm.user_id ? (
        <>
          <ViewDescricaoText acm={acm} position="right" user_id={userDados.id} />
        ...
        <>
          ...
          <ViewDescricaoText acm={acm} position="left" />
        </>
      )}
    </div>
  );
