...
-- Tue Aug 11 11:48:26 2020
-- Model: New Model    Version: 0.0.2
...
CREATE TABLE IF NOT EXISTS `segchamados`.`sub_categorias` (
  ...
  `updated_at` DATETIME NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_sub_categorias_categorias1_idx` (`categorias_id` ASC),
  INDEX `fk_sub_categorias_users1_idx` (`user_id` ASC),
  UNIQUE INDEX `nome_UNIQUE` (`nome` ASC),
  CONSTRAINT `fk_sub_categorias_categorias1` FOREIGN KEY (`categorias_id`) REFERENCES `segchamados`.`categorias` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
